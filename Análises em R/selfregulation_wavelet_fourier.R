...
ldata.train=list("df"=as.data.frame(y_train),"x1"=x.v2.fdata,"x2" =x.v3.fdata, "x3" =x.v4.fdata, "x4" =x.v5.fdata)  
...
res.basis=fregre.glm(y_train~x1 + x2 + x3 + x4,ldata.train,family=binomial(),basis.x=basis.x,basis.b=basis.b, CV=TRUE)    
...
ldata.test=list("df"=as.data.frame(y_test),"x1"=x.v2.fdata_test,"x2" =x.v3.fdata_test, "x3" =x.v4.fdata_test, "x4" =x.v5.fdata_test) 
