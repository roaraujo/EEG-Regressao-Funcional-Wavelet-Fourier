...
basis.x1=create.fdata.basis(x.v2.fdata,type.basis="fourier", l=1:8); basis.x2=create.fdata.basis(x.v3.fdata,type.basis="fourier", l=1:8) 
basis.x3=create.fdata.basis(x.v4.fdata,type.basis="fourier", l=1:8); basis.x4=create.fdata.basis(x.v5.fdata,type.basis="fourier", l=1:8) 
basis.x5=create.fdata.basis(x.v6.fdata,type.basis="fourier", l=1:8); basis.x6=create.fdata.basis(x.v7.fdata,type.basis="fourier", l=1:8) 
...
basis.b1=create.fdata.basis(x.v2.fdata,type.basis="fourier", l=1:8); basis.b2=create.fdata.basis(x.v3.fdata,type.basis="fourier", l=1:8)
basis.b3=create.fdata.basis(x.v4.fdata,type.basis="fourier", l=1:8); basis.b4=create.fdata.basis(x.v5.fdata,type.basis="fourier", l=1:8)
basis.b5=create.fdata.basis(x.v6.fdata,type.basis="fourier", l=1:8); basis.b6=create.fdata.basis(x.v7.fdata,type.basis="fourier", l=1:8)
